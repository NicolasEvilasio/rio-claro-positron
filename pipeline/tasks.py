...
#     return {
#         'rss': f"{memory_info.rss / 1024 / 1024:.2f} MB",  # Memória RAM física
#         'vms': f"{memory_info.vms / 1024 / 1024:.2f} MB",  # Memória virtual
#         'percent': f"{process.memory_percent():.1f}%"       # Porcentagem do total
#     }
...
def get_on_redis(
    ...
    # print(f"Memória depois de get_on_redis: {get_memory_usage()}")
    return result
